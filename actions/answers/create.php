<?php
	...
	$db = new MindReadrDb();
	$db->createAnswer($answer, $answer_type, 0, $media0, $media0_type);
	$db->createAnswer($answer, $answer_type, 1, $media1, $media1_type);
	$db->createAnswer($answer, $answer_type, 2, $media2, $media2_type);
?>

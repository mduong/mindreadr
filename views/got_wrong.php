<?php
	...
	$db->fail($game_id, $_SESSION["me"]["id"]);
...
<div data-role="page">
	...
	<div data-role="content">
		...
		<h4>Sorry, you ran out of guesses!</h4>
		<p><strong>The answer was:</strong> <?php echo $answer->{"answer"}; ?><strong>.</strong></p>
		<h4>This is what <?php echo $opponent->{"first_name"}; ?> worked with:</h4>
		<?php
			if ($answer->{"type"} == "text") {
